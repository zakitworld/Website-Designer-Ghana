...
namespace Website_Designer_Ghana.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorWebsite = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseLessons_OrderIndex",
                table: "CourseLessons",
                column: "OrderIndex");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Portfolios_IsFeatured",
                table: "Portfolios",
                column: "IsFeatured");

            migrationBuilder.CreateIndex(
                name: "IX_Portfolios_IsPublished",
                table: "Portfolios",
                column: "IsPublished");
